      ...
      <div class="row">
        <div class="col-12">
          <div class="headerArea">
            <img id="logo" src="./assets/img/icon/logo-min.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-6">
          ...
          <div id="countdownTwo">
            <div class="countdown-sectionTwo ">
              <div class="timeName">DAYS</div>
              <span class="daysTwo ">-</span>
            </div>
            <div class="countdown-sectionTwo ">
              <div class="timeName">HRS</div>
              <span class="hoursTwo ">-</span>
            </div>
            <div class="countdown-sectionTwo ">
              <div class="timeName">MINS</div>
              <span class="minutesTwo "></span>
            </div>
            <div class="countdown-sectionTwo ">
              <div class="timeName">SECS</div>
              <span class="secondsTwo "></span>
            </div>
          </div>
        </div>
  ...
  <section class="roadMap">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div id="journey" class="rHood">
            <h6>JOURNEY</h6>
            <img class="d-none d-lg-block" src="./assets/img/icon/roadMapLine.png" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="row thirtArea">
        <div class="col-12 col-lg-6">
          <img class="phaseImg d-block d-lg-none" src="./assets/img/icon/p3.png" alt="">
          <div class="textArea" data-aos="fade-up">
            <p>IDO</p>
            <p>EMD Token</p>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
      ...
      <div class="phaseArea d-block d-lg-none">
        <img src="./assets/img/icon/p5.png" alt="">
        <img src="./assets/img/icon/p6.png" alt="">
        <img src="./assets/img/icon/p7.png" alt="">
      </div>
    </div>
    <div class="container">
      <div class="row">
